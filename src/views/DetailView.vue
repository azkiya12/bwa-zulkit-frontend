...
const features = computed(() => {
    return detail.value.features.split(',')
})
                ...
                <aside class="w-full px-4 sm:w-1/3 md:w-1/3">
                    <div class="sticky top-0 w-full pt-4 md:mt-24 ">
                        <div class="p-6 border rounded-2xl">
                            ...
                            <div class="mb-4" v-if="detail.is_sketch == 1">
                                <div class="flex mb-2">
                                    <div>
                            ...
                            <div>
                                ...
                                <ul class="mb-6 text-gray-500" v-if="detail">
                            ...
                            <a :href="detail.file" v-if="user.data.subscription.length > 0"
