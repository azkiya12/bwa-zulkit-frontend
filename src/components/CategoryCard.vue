...
<template>
    <div class="w-full px-1 my-1 md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
        <div class="overflow-hidden border border-gray-200 rounded-xl">
            <RouterLink :to="{ name: 'categories->items', params: { id: id }}">
            ...
            <header class="px-4 mb-4 leading-tight">
                <h1 class="text-lg">
                    <RouterLink  :to="{ name: 'categories->items', params: { id: id }}" class="font-semibold text-black no-underline hover:underline">
                        {{ title }}
                    </RouterLink>
                </h1>
